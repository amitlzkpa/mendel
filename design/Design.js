...
// inner profile
var i_bs_pts_start = [ 		[200, 0, -1836],	[200, 0, 252], 		[200, 0, 605] 		];
var i_bk_pts_start = [ 		[200, 0, 605], 		[200, 400, 720], 	[200, 852, 716] 	];
var i_tp_pts_start = [		[200, 852, 716], 	[200, 920, 627], 	[200, 520, 552] 	];
var i_st_pts_start = [		[200, 520, 552], 	[200, 520, 366], 	[200, 520, -1836]	];
var i_ft_pts_start = [		[200, 520, -1836], 	[200, 456, -1886],	[200, 0, -1850]		];


// outer profile
var o_bs_pts_start = [		[360, 0, -1837],	[360, 0, 240],		[360, 0, 530]		];
var o_bk_pts_start = [		[360, 0, 530],		[360, 540, 660],	[360, 907, 640]		];
var o_tp_pts_start = [		[360, 907, 640],	[360, 965, 570],	[360, 520, 510]		];
var o_st_pts_start = [		[360, 520, 510],	[360, 520, 330],	[360, 520, -1837]	];
var o_ft_pts_start = [		[360, 520, -1837],	[360, 405, -1925],	[360, 0, -1850]		];



var i_bs_pts_mirr_start = [ 	[-200, 0, -1836],	[-200, 0, 252], 	[-200, 0, 605] 		];
var i_bk_pts_mirr_start = [ 	[-200, 0, 605], 	[-200, 400, 720], 	[-200, 852, 716] 	];
var i_tp_pts_mirr_start = [		[-200, 852, 716], 	[-200, 920, 627], 	[-200, 520, 552] 	];
var i_st_pts_mirr_start = [		[-200, 520, 552], 	[-200, 520, 366], 	[-200, 520, -1836]	];
var i_ft_pts_mirr_start = [		[-200, 520, -1836], [-200, 456, -1886],	[-200, 0, -1850]	];


var o_bs_pts_mirr_start = [		[-360, 0, -1837],	[-360, 0, 240],		[-360, 0, 530]		];
var o_bk_pts_mirr_start = [		[-360, 0, 530],		[-360, 540, 660],	[-360, 907, 640]	];
var o_tp_pts_mirr_start = [		[-360, 907, 640],	[-360, 965, 570],	[-360, 520, 510]	];
var o_st_pts_mirr_start = [		[-360, 520, 510],	[-360, 520, 330],	[-360, 520, -1837]	];
var o_ft_pts_mirr_start = [		[-360, 520, -1837],	[-360, 405, -1925],	[-360, 0, -1850]	];
